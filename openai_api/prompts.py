...
CATEGORIZE_TASK = "Представь, что ты рубрикатор для набора постов. Необходимо придумать короткое, ёмкое, но исчерпывающее название, которое отлично опишет суть происходящего в наборе новостей. Смысл названия должен быть не слишком общим - должен отражать детали этого конкретногj сюжета, но и не слишком подробным - всё ещё подходить под все тексты. \n Отвечай только названием рубрики без кавычек, дополнительных комментариев и пояснений от себя."
